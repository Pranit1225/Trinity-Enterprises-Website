...
const operatingAreas = [
  [
    "01",
    "Construction",
    "Equipment and solutions supporting demanding construction environments.",
  ],
  [
    "02",
    "Mining",
    "Material processing and equipment for quarrying and mining applications.",
  ],
  [
    "03",
    "Infrastructure",
    "Road, asphalt and allied equipment for infrastructure projects.",
  ],
  [
    "04",
    "Industrial",
    "Power, chemicals, classification and complementary industrial solutions.",
  ],
];
...
const reasons = [
  [
    "01",
    "Industry knowledge",
    "Placeholder proof point for practical domain understanding and project conversations.",
    Network,
  ],
  [
    "02",
    "Equipment portfolio",
    "A diverse portfolio spanning mobile and stationary equipment and allied solutions.",
    Gauge,
  ],
  [
    "03",
    "Manufacturer network",
    "Partner brands across construction, mining, road and industrial applications.",
    Globe2,
  ],
  [
    "04",
    "Project support",
    "Placeholder proof point for technical, commercial and after-sales support.",
    ShieldCheck,
  ],
];
...
function ScrollProgress() {
  ...
  return (
    <motion.div
      className="fixed left-0 right-0 top-0 z-[80] h-[2px] origin-left bg-[#d9a62e]"
      style={{ scaleX }}
    />
  );
}
  ...
  return (
    <motion.a
      ...
      className={`group inline-flex items-center justify-center gap-2 rounded-full px-6 py-4 text-sm font-bold transition ${
        dark
          ? "bg-[#0b1821] text-white hover:bg-[#1677a6]"
          : "bg-[#d9a62e] text-[#0b1821] hover:bg-white"
      }`}
    >
      {children}
      <ArrowRight
  ...
  return (
    <>
      ...
      <main id="main-content" className="relative overflow-hidden bg-[#f5f3ee] text-[#111820]">
                    ...
                    >
                      {productOfferings.map((partner) => (
                        <a
                          ...
                          className="group flex items-center justify-between rounded-xl px-4 py-3 text-sm text-white/65 transition hover:bg-white/7 hover:text-white"
                        >
                          <span>{partner.name}</span>
                          <span className="font-mono text-[9px] text-white/20 group-hover:text-[#d9a62e]">
                            {partner.number}
                          </span>
                        </a>
                      ))}
              ...
              >
                {[
                  ...
                  <a
                    ...
                    href={href}
                    onClick={closeMenu}
                    className="block rounded-2xl px-4 py-4 text-sm text-white/75 hover:bg-white/7 hover:text-white"
                  >
                    {label}
                  </a>
                ))}
        ...
        <section
          id="home"
          className="relative min-h-[760px] overflow-hidden bg-[#07161f] text-white md:min-h-screen"
        >
          ...
          <motion.div
            ...
            className="relative mx-auto grid min-h-screen max-w-[1380px] items-center gap-14 px-6 pb-20 pt-32 md:grid-cols-[.98fr_1.02fr] md:px-10 md:pt-28"
          >
            <motion.div
              initial="hidden"
              animate="visible"
              variants={{ visible: { transition: { staggerChildren: 0.085 } } }}
              className="relative z-10"
            >
              <motion.div
                variants={fadeUp}
                className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/12 bg-white/5 px-4 py-2 text-[10px] font-bold uppercase tracking-[0.2em] text-white/55"
              >
              ...
              <motion.p
                variants={fadeUp}
                className="max-w-4xl text-[clamp(3.5rem,7.3vw,7.4rem)] font-semibold leading-[.84] tracking-[-.065em]"
              >
              ...
              <motion.p
                variants={fadeUp}
                className="mt-8 max-w-xl text-base leading-7 text-white/48 md:text-lg"
              >
                Trinity Enterprises represents a diverse portfolio of mobile and
                stationary crushers, sand washing plants, road equipment,
                construction chemicals, gensets and sand air classifiers.
              </motion.p>
              <motion.div
                variants={fadeUp}
              ...
              >
                ...
                <a
                  href="#about"
                  className="group inline-flex items-center justify-center gap-2 rounded-full border border-white/15 px-6 py-4 text-sm font-semibold text-white/75 transition hover:border-white/35 hover:bg-white/6"
                >
                  Discover Trinity{" "}
                  <ArrowDownRight
                    size={16}
              ...
              <motion.div
                variants={fadeUp}
                className="mt-12 grid max-w-xl grid-cols-2 gap-3 text-[9px] uppercase tracking-[0.18em] text-white/35 sm:grid-cols-4"
              >
                {["Construction", "Mining", "Infrastructure", "Industrial"].map(
                  (item) => (
                    <span key={item} className="border-l border-white/10 pl-3">
                      {item}
                    </span>
                  ),
                )}
            ...
            >
              <div className="hero-machine-panel relative aspect-[.92] overflow-hidden rounded-[2.2rem] border border-white/10 bg-[#0c202b] shadow-2xl shadow-black/40">
                ...
                <div className="absolute left-5 top-5 flex items-center gap-2 rounded-full border border-white/10 bg-black/20 px-3 py-2 text-[9px] font-bold uppercase tracking-[.18em] text-white/45 backdrop-blur">
                  <CircleDot size={10} className="text-[#d9a62e]" /> Visual
                  placeholder
                </div>
                <div className="absolute right-5 top-5 font-mono text-[9px] text-white/25">
                  TE / 001
                </div>
                ...
                <div className="absolute bottom-5 left-5 right-5 grid gap-3 sm:grid-cols-[1fr_auto]">
                  <div className="rounded-2xl border border-white/10 bg-[#07161f]/75 p-4 backdrop-blur-xl">
                    ...
                    <p className="mt-2 text-xl font-semibold tracking-tight">
                      Real imagery goes here.
                    </p>
                    <p className="mt-1 text-xs text-white/38">
                      High-resolution company machinery photography will replace
                      this placeholder.
                    </p>
                  </div>
          ...
          <div className="absolute bottom-5 left-1/2 hidden -translate-x-1/2 items-center gap-3 text-[9px] uppercase tracking-[.28em] text-white/25 md:flex">
            <span className="h-px w-10 bg-white/15" /> Scroll to explore{" "}
        ...
        <section className="relative overflow-hidden border-y border-black/5 bg-white py-5">
          <div className="mx-auto flex max-w-[1380px] items-center gap-6 px-6">
            <span className="hidden shrink-0 text-[9px] font-bold uppercase tracking-[.22em] text-black/30 md:block">
              Partner network
            </span>
            <div className="partner-mask min-w-0 overflow-hidden">
              <div className="partner-track flex w-max items-center gap-10">
                {[...partners, ...partners].map((partner, i) => (
                  <span
                    key={`${partner}-${i}`}
                    className="flex items-center gap-3 whitespace-nowrap text-sm font-semibold text-black/48"
                  >
                    <span className="partner-dot h-1.5 w-1.5 rounded-full" />
                    {partner}
                  </span>
                ))}
              </div>
        ...
        >
          <div className="mx-auto max-w-[1380px]">
            <Reveal className="grid gap-10 md:grid-cols-[.78fr_1.22fr] md:items-end">
              ...
              <motion.div
                variants={fadeUp}
                className="max-w-2xl md:justify-self-end"
              >
                <p className="section-copy">
                  A diverse portfolio for construction, mining and
                  infrastructure applications. The structure below is ready for
                  the final product catalogue once the imagery and verified
                  product details are supplied.
                </p>
              </motion.div>
            </Reveal>
            ...
            <div className="mt-16 grid overflow-hidden rounded-[2rem] border border-black/10 bg-white shadow-[0_25px_80px_rgba(11,24,33,.08)] md:grid-cols-2">
              {capabilities.map((item, index) => {
                ...
                return (
                  <MotionLink
                    href={
                      item.title === "Trinity Imports & Exports"
                        ? "/products/trinity-imports-exports"
                        : "/products"
                    }
                    key={item.number}
                  ...
                  >
                    ...
                    <div className="relative flex items-start justify-between">
                      <div className="capability-icon flex h-11 w-11 items-center justify-center rounded-2xl">
                        <Icon size={19} />
                      </div>
                    ...
                    <div className="relative mt-16">
                      <p className="capability-eyebrow text-[9px] font-bold uppercase tracking-[.2em]">
                        {item.eyebrow}
                      </p>
                      ...
                      <p className="mt-5 max-w-lg text-sm leading-6 text-current/45">
                        {item.copy}
                      </p>
                    </div>
                    <div
                      className={`absolute bottom-7 left-7 flex items-center gap-2 text-xs font-bold ${item.accent === "dark" ? "text-white" : "text-[#111820]"}`}
                    >
                      View solution{" "}
                      <ChevronRight
                        size={15}
            ...
            <Reveal className="mt-12 grid gap-5 md:grid-cols-[1.15fr_.85fr]">
              <motion.div
                variants={fadeUp}
                className="relative overflow-hidden rounded-[2rem] bg-[#0b1821] p-8 text-white md:p-10"
              >
                ...
                <div className="relative">
                  ...
                  <h3 className="mt-4 max-w-xl text-3xl font-semibold tracking-[-.04em] md:text-4xl">
                    One network. Multiple industrial applications.
                  </h3>
                  <p className="mt-4 max-w-2xl text-sm leading-6 text-white/45">
                    Use this space for a concise explanation of how Trinity
                    connects manufacturers, equipment and customer requirements.
                    Final copy remains a placeholder.
                  </p>
                </div>
                <div className="relative mt-10 grid grid-cols-2 gap-4 sm:grid-cols-5">
                  {[
                    ...
                    <div
                      key={x}
                      className="border-l border-white/10 pl-3 text-xs font-semibold text-white/60"
                    >
                      {x}
                    </div>
                  ))}
              ...
              <motion.div
                variants={fadeUp}
                className="rounded-[2rem] border border-black/10 bg-[#e9eef0] p-8 md:p-10"
              >
                <p className="eyebrow">Placeholder asset</p>
                <div className="mt-12 flex min-h-[160px] items-center justify-center rounded-[1.5rem] border border-dashed border-black/15 bg-white/45 text-center">
                  <div>
                    <CircleDot className="mx-auto text-[#1677a6]" size={20} />
                    <p className="mt-3 text-sm font-semibold">
                      Product / machinery visual goes here
                    </p>
                    <p className="mt-1 text-xs text-black/40">
                      Images will be added in the next content pass.
                    </p>
                  </div>
                </div>
              </motion.div>
            ...
            <Reveal className="mt-6">
              <motion.div
                variants={fadeUp}
                className="relative overflow-hidden rounded-[2rem] border border-[#55c9a4]/25 bg-gradient-to-br from-[#e7fbf4] via-white to-[#e7f7fa] p-8 shadow-[0_22px_70px_rgba(11,24,33,.08)] md:p-10"
              >
                <div className="absolute -right-12 -top-20 h-64 w-64 rounded-full bg-[#55c9a4]/18 blur-3xl" />
                <div className="relative grid gap-8 md:grid-cols-[1fr_auto] md:items-end">
                  <div>
                    <div className="inline-flex items-center gap-2 rounded-full bg-white/75 px-3 py-2 text-[9px] font-extrabold uppercase tracking-[.2em] text-[#238e6c]">
                      <Globe2 size={12} /> Global trade pathway
                    </div>
                    <h3 className="mt-5 max-w-3xl text-3xl font-semibold tracking-[-.04em] md:text-5xl">
                      Trinity Imports &amp; Exports Solutions
                    </h3>
                    <p className="mt-4 max-w-3xl text-sm leading-7 text-black/50">
                      Encouraging foreign trade opportunities alongside our
                      equipment and industrial portfolio. International
                      sourcing, imports, exports, trade routes and supported
                      categories will be detailed here once the final Trinity
                      offering is verified.
                    </p>
                  </div>
                  <Link
                    href="/products/trinity-imports-exports"
                    className="inline-flex items-center justify-center gap-2 rounded-full bg-[#081923] px-6 py-4 text-sm font-bold text-white hover:bg-[#1688c7]"
                  >
                    Explore imports &amp; exports <ArrowRight size={16} />
                  </Link>
                </div>
              </motion.div>
            </Reveal>
          ...
          <div className="mx-auto max-w-[1380px]">
            <Reveal>
              <motion.div variants={fadeUp} className="max-w-3xl">
                <p className="eyebrow">02 · Operating spectrum</p>
                <h2 className="section-title mt-4">
                  From <span className="text-[#1677a6]">material</span> to
                  movement.
                </h2>
                <p className="section-copy mt-6">
                  The final content can turn this into a clear visual map of the
                  markets Trinity serves. For now, it gives the site a strong
                  editorial rhythm without inventing claims.
                </p>
              </motion.div>
            </Reveal>
            <div className="mt-14 grid gap-8 lg:grid-cols-[.7fr_1.3fr]">
              <div className="rounded-[2rem] bg-[#0b1821] p-6 text-white md:p-8">
                <div className="mb-8 flex items-center justify-between">
                  <span className="text-[9px] font-bold uppercase tracking-[.2em] text-white/35">
                    Industry map
                  </span>
                  <span className="font-mono text-[9px] text-[#d9a62e]">
                    TRINITY / 04
                  </span>
                </div>
                <div className="space-y-2">
                  {operatingAreas.map(([n, title], index) => (
                    <button
                      key={n}
                      onClick={() => setActiveArea(index)}
                      className={`area-tab group flex w-full items-center justify-between rounded-2xl px-4 py-4 text-left transition ${activeArea === index ? "bg-white/8" : "hover:bg-white/5"}`}
                    >
                      <span className="flex items-center gap-4">
                        <span
                          className={`font-mono text-[10px] ${activeArea === index ? "text-[#d9a62e]" : "text-white/25"}`}
                        >
                          {n}
                        </span>
                        <span
                      ...
                      <ChevronRight
                        size={15}
                        className={`transition ${activeArea === index ? "translate-x-1 text-[#d9a62e]" : "text-white/15"}`}
                      />
                    </button>
                  ))}
                </div>
              ...
              <div className="relative min-h-[390px] overflow-hidden rounded-[2rem] border border-black/8 bg-white p-8 md:p-12">
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div>
                      <div className="flex items-center gap-2 text-[9px] font-bold uppercase tracking-[.2em] text-[#1677a6]">
                        <CircleDot size={10} /> 0{activeArea + 1} / Focus area
                      </div>
                      <h3 className="mt-7 text-5xl font-semibold tracking-[-.055em] md:text-7xl">
                        {operatingAreas[activeArea][1]}
                      </h3>
                      <p className="mt-6 max-w-xl text-base leading-7 text-black/50">
                        {operatingAreas[activeArea][2]} Final company-specific
                        proof points and project examples will be added here.
                      </p>
                    </div>
                    <div className="mt-12 flex items-center gap-4">
                      <span className="h-px w-16 bg-black/10" />
                      <span className="text-[9px] uppercase tracking-[.2em] text-black/30">
                        Content placeholder
                      </span>
                    </div>
                  </motion.div>
        ...
        <section
          id="about"
          className="relative overflow-hidden bg-[#091720] px-6 py-24 text-white md:py-32"
        >
          ...
          <div className="relative mx-auto max-w-[1380px]">
            <Reveal className="grid gap-14 md:grid-cols-[.85fr_1.15fr] md:items-end">
              <motion.div variants={fadeUp}>
                <p className="eyebrow text-white/35">03 · About Trinity</p>
                <h2 className="mt-5 max-w-xl text-5xl font-semibold tracking-[-.055em] md:text-7xl">
                  A stronger{" "}
                  <span className="text-gradient-warm">digital face</span> for
                  an engineering-led business.
                </h2>
              </motion.div>
              <motion.div variants={fadeUp}>
                <p className="max-w-3xl text-lg leading-8 text-white/55">
                  Trinity Enterprises is an Authorised Dealer in Construction &
                  Mining Equipment, representing a diverse portfolio of mobile
                  and stationary crushers, sand washing plants, wet mix and hot
                  mix plants, bitumen sprayers, construction chemicals, gensets,
            ...
            <div className="mt-16 grid border-y border-white/10 md:grid-cols-4">
              {[
                ...
                >
                  ...
                  <p className="mt-2 text-[9px] uppercase tracking-[.18em] text-white/30">
                    {l}
                  </p>
                </motion.div>
              ))}
            ...
            <div className="mt-14 grid gap-5 md:grid-cols-3">
              <div className="rounded-[2rem] border border-white/10 bg-white/[.035] p-7">
                ...
                <p className="mt-5 text-sm leading-7 text-white/45">
                  Verified company history, years of operation and milestone
                  information will be inserted once Dad confirms the final
                  content.
                </p>
              </div>
              <div className="rounded-[2rem] border border-white/10 bg-white/[.035] p-7">
                <p className="text-[9px] font-bold uppercase tracking-[.2em] text-[#1677a6]">
                  Placeholder · reach
                </p>
                <p className="mt-5 text-sm leading-7 text-white/45">
                  Customer segments, project locations and service reach can be
                  showcased here without changing the underlying layout.
                </p>
              </div>
              <div className="relative overflow-hidden rounded-[2rem] border border-[#d9a62e]/20 bg-[#d9a62e] p-7 text-[#0b1821]">
                <p className="text-[9px] font-bold uppercase tracking-[.2em] text-[#0b1821]/55">
                  Content-ready
                </p>
                <p className="mt-5 text-2xl font-semibold tracking-[-.03em]">
                  This design is ready for the real Trinity story.
                </p>
                <p className="mt-4 text-sm leading-6 text-[#0b1821]/60">
                  No redesign required when the final copy arrives.
                </p>
                <MoveUpRight className="absolute bottom-6 right-6" size={20} />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section-cursor-field relative bg-white px-6 py-24 md:py-32">
          <div className="mx-auto max-w-[1380px]">
            <Reveal className="grid gap-10 md:grid-cols-[.7fr_1.3fr] md:items-end">
              <motion.div variants={fadeUp}>
                <p className="eyebrow">04 · Why Trinity</p>
                <h2 className="section-title mt-4">
                  Built on{" "}
                  <span className="text-gradient-blue">
              ...
              <motion.p
                variants={fadeUp}
                className="max-w-2xl text-base leading-7 text-black/45 md:justify-self-end"
              >
                A visual framework for the proof points that matter to customers
                evaluating construction and mining equipment partners.
              </motion.p>
            </Reveal>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#edf5f7] text-[#1677a6] transition group-hover:bg-[#d9a62e] group-hover:text-[#0b1821]">
                        <ReasonIcon size={18} />
                      </div>
                      <span className="font-mono text-[10px] text-black/20">
                        {n as string}
                    ...
                    <div className="mt-8 h-px w-0 bg-[#d9a62e] transition-all duration-500 group-hover:w-full" />
                  </motion.div>
                );
              })}
            </div>
        ...
        >
          ...
          <div className="relative mx-auto max-w-[1380px]">
            <div className="grid gap-14 md:grid-cols-[.75fr_1.25fr] md:items-start">
              <Reveal>
                <motion.div variants={fadeUp}>
                  <p className="eyebrow text-[#0b1821]/55">05 · Get in touch</p>
                  <h2 className="mt-4 max-w-xl text-5xl font-semibold tracking-[-.055em] text-[#0b1821] md:text-7xl">
                ...
                <motion.div
                  variants={fadeUp}
                  className="mt-10 space-y-5 text-sm text-[#0b1821]/70"
                >
                  <p>
                    <strong className="text-[#0b1821]">Email</strong>
                    <br />
                    <a
                      href="mailto:trinity1entp@gmail.com"
            ...
            <div className="mt-16 overflow-hidden rounded-[2rem] border border-[#0b1821]/15 bg-[#0b1821] p-2 shadow-2xl shadow-[#0b1821]/15">
              <div className="relative overflow-hidden rounded-[1.5rem] bg-[#172630]">
                <div className="absolute left-4 top-4 z-10 flex items-center gap-2 rounded-full border border-white/10 bg-[#0b1821]/85 px-4 py-2 text-[10px] font-bold uppercase tracking-[.18em] text-white/70 backdrop-blur">
                  <MapPin size={11} className="text-[#d9a62e]" /> Trinity
                  Enterprises · Pune office
                </div>
                <iframe
                  title="Trinity Enterprises office location"
                  className="h-[340px] w-full border-0 grayscale-[.4] opacity-90 md:h-[430px]"
                  loading="lazy"
        ...
        <footer className="bg-[#303030] px-6 py-12 text-white">
          <div className="mx-auto max-w-[1380px]">
            <div className="grid gap-10 border-b border-white/10 pb-10 md:grid-cols-[1fr_auto] md:items-end">
              <div>
                ...
                <p className="mt-2 max-w-xl text-sm leading-6 text-white/40">
                  Authorised dealer in construction & mining equipment, with a
                  diverse portfolio of equipment and industrial solutions.
                </p>
              </div>
              <a
                href="#home"
            ...
            <div className="grid gap-8 py-10 text-sm text-white/65 md:grid-cols-3">
              <div>
                <p className="text-[9px] font-bold uppercase tracking-[.2em] text-white/30">
                  Contact
                </p>
                <p className="mt-3">trinity1entp@gmail.com</p>
            ...
            <div className="border-t border-white/10 pt-8 text-xs leading-6 text-white/45">
              <p>
